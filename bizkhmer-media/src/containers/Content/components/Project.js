                ...
                <div className="vc_column-inner">
                  <div className="wpb_wrapper">
                    ...
                    >
                      ...
                      />
                      <div id="editor">
                        <h4 className="sub_title_a" id="sub_project">
                          {sub_project_title}
                        </h4>
                      </div>
                    </div>
                  ...
                  <div className="wpb_wrapper">
                    ...
                    >
                      ...
                      <h3
                        ...
                        data-file={1024}
                        id="project_award_count"
                      >
                        {project_award_count}
                      </h3>
                      <h4 className="wd-count-up__title" id="project_award">
                        {project_award}
                      </h4>
                    </div>
                    <div
                  ...
                  <div className="wpb_wrapper">
                    ...
                    >
                      ...
                      <h3
                        className="wd-count-up__counter"
                        data-file={24}
                        id="project_project_count"
                      >
                        {project_project_count}
                      </h3>
                      <h4 className="wd-count-up__title" id="project_project">
                        {project_project}
                      </h4>
                    </div>
                    <div
                  ...
                  <div className="wpb_wrapper">
                    ...
                    >
                      ...
                      <h3
                        className="wd-count-up__counter"
                        data-file={1024}
                        id="project_happy_clients_count"
                      >
                        {project_happy_clients_count}
                      </h3>
                      <h4
                        className="wd-count-up__title"
                        id="project_happy_clients"
                      >
                        {project_happy_clients}
                      </h4>
                    </div>
                  ...
                  <div className="wpb_wrapper">
                    ...
                    >
                      ...
                      <h3
                        className="wd-count-up__counter"
                        data-file="99.9"
                        id="project_up_time_count"
                      >
                        {project_up_time_count}
                      </h3>
                      <h4 className="wd-count-up__title" id="project_up_time">
                        {project_up_time}
                      </h4>
                    </div>
                    <div
