              ...
              <div className="testimonail-item">
                ...
                >
                  ...
                  <div
                    ...
                    style={{ color: '#718494' }}
                  >
                    <p id="first-feedback">{first_feedback}</p>
                    <h6
                      className="name"
                      style={{ color: '#718494' }}
                      id="first-feedback-name"
                    >
                      {first_feedback_name}
                    </h6>
                  </div>
              ...
              <div className="testimonail-item">
                ...
                >
                  ...
                  <div
                    ...
                    style={{ color: '#718494' }}
                  >
                    <p id="second-feedback">{second_feedback}</p>
                    <h6
                      className="name"
                      style={{ color: '#718494' }}
                      id="second-feedback-name"
                    >
                      {second_feedback_name}
                    </h6>
                  </div>
              ...
              <div className="testimonail-item">
                ...
                >
                  ...
                  <div
                    ...
                    style={{ color: '#718494' }}
                  >
                    <p id="third-feedback">{third_feedback}</p>
                    <h6
                      className="name"
                      style={{ color: '#718494' }}
                      id="third-feedback-name"
                    >
                      {third_feedback_name}
                    </h6>
                  </div>
