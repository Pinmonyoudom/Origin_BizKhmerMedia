          ...
          <div className="vc_column-inner">
            <div className="wpb_wrapper">
              ...
              >
                ...
                <p style={{}} className="sub_title_a" id="sub-process-title">
                  {sub_process_title}
                </p>
              </div>
              <div
                    ...
                    <div className="vc_tta-panels">
                      ...
                      >
                        <div className="vc_tta-panel-heading">
                          <h4 className="vc_tta-panel-title vc_tta-controls-icon-position-right">
                            ...
                            >
                              <i className="vc_tta-icon fa fa-calendar" />
                        ...
                        <div className="vc_tta-panel-body">
                          <div className="wpb_text_column wpb_content_element  vc_custom_1555409397545">
                            <div className="wpb_wrapper">
                              <p>{sub_process_strategy_a}</p>
                              <p>{sub_process_strategy_b}</p>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      >
                        <div className="vc_tta-panel-heading">
                          <h4 className="vc_tta-panel-title vc_tta-controls-icon-position-right">
                            <a
                              ...
                              data-vc-container=".vc_tta-container"
                            >
                              <i className="vc_tta-icon fa fa-file-image-o" />
                              <span className="vc_tta-title-text">
                                {process_make_design}
                              </span>
                              <i className="vc_tta-controls-icon vc_tta-controls-icon-plus" />
                        ...
                        <div className="vc_tta-panel-body">
                          <div className="wpb_text_column wpb_content_element ">
                            <div className="wpb_wrapper">
                              <p>{sub_process_make_design_b}</p>
                              <p>{sub_process_make_design_a}</p>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      >
                        <div className="vc_tta-panel-heading">
                          <h4 className="vc_tta-panel-title vc_tta-controls-icon-position-right">
                            <a
                              ...
                              data-vc-container=".vc_tta-container"
                            >
                              <i className="vc_tta-icon fa fa-sliders" />
                              <span className="vc_tta-title-text">
                                {process_develop}
                              </span>
                              <i className="vc_tta-controls-icon vc_tta-controls-icon-plus" />
                        ...
                        <div className="vc_tta-panel-body">
                          <div className="wpb_text_column wpb_content_element ">
                            <div className="wpb_wrapper">
                              <p>{sub_process_develop_a}</p>
                              <p>{sub_process_develop_b}</p>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      >
                        <div className="vc_tta-panel-heading">
                          <h4 className="vc_tta-panel-title vc_tta-controls-icon-position-right">
                            <a
                              ...
                              data-vc-container=".vc_tta-container"
                            >
                              <i className="vc_tta-icon fa fa-thumbs-o-up" />
                              <span className="vc_tta-title-text">
                                {process_class_support}
                              </span>
                              <i className="vc_tta-controls-icon vc_tta-controls-icon-plus" />
                        ...
                        <div className="vc_tta-panel-body">
                          <div className="wpb_text_column wpb_content_element ">
                            <div className="wpb_wrapper">
                              <p>{sub_process_class_support_a}</p>
                              <p>{sub_process_class_support_b}</p>
                            </div>
                          </div>
                        </div>
                      </div>
