        ...
        <div className="vc_column-inner">
          <div className="wpb_wrapper">
            ...
            >
              ...
              />
              <p style={{}} className="sub_title_b" id="sub-award">
                {sub_award}
              </p>
            </div>
            <div
          ...
          <div className="wpb_wrapper">
            ...
            >
              <div className="text-icon__container  center ">
                ...
                <div className="text-icon__content-box">
                  <h4 className="text-icon__title" id="award-marketing">
                    {award_marketing}
                  </h4>
                  <p className="text-icon__text" id="sub-award-marketing">
                    {sub_award_marketing}
                  </p>
                </div>
              </div>
          ...
          <div className="wpb_wrapper">
            ...
            >
              <div className="text-icon__container  center ">
                ...
                <div className="text-icon__content-box">
                  <h4 className="text-icon__title" id="award-web-design">
                    {award_web_design}
                  </h4>
                  <p className="text-icon__text" id="sub-award-web-design">
                    {sub_award_web_design}
                  </p>
                </div>
              </div>
            ...
            >
              <div className="text-icon__container  center ">
                ...
                <div className="text-icon__content-box">
                  <h4 className="text-icon__title" id="award-seo">
                    {award_seo}
                  </h4>
                  <p className="text-icon__text" id="sub-award-seo">
                    {sub_award_seo}
                  </p>
                </div>
              </div>
