          ...
          <div className="wpb_wrapper">
            ...
            >
              <div className="text-icon__container   ">
                ...
                <div className="text-icon__content-box">
                  <h4 className="text-icon__title" id="business-web-design">
                    {business_web_design}
                  </h4>
                  <p className="text-icon__text" id="sub-business-web-design">
                    {sub_business_web_design}
                  </p>
                </div>
              </div>
            ...
            >
              <div className="text-icon__container   ">
                ...
                <div className="text-icon__content-box">
                  <h4 className="text-icon__title" id="business-branding">
                    {business_branding}
                  </h4>
                  <p className="text-icon__text" id="sub-business-branding">
                    {sub_business_branding}
                  </p>
                </div>
              </div>
          ...
          <div className="wpb_wrapper">
            ...
            >
              <div className="text-icon__container   ">
                ...
                <div className="text-icon__content-box">
                  <h4 className="text-icon__title" id="business-development">
                    {business_development}
                  </h4>
                  <p className="text-icon__text" id="sub-business-development">
                    {sub_business_development}
                  </p>
                </div>
              </div>
            ...
            >
              <div className="text-icon__container   ">
                ...
                <div className="text-icon__content-box">
                  <h4 className="text-icon__title" id="business-ecommerce">
                    {business_ecommerce}
                  </h4>
                  <p className="text-icon__text" id="sub-business-ecommerce">
                    {sub_business_ecommerce}
                  </p>
                </div>
              </div>
          ...
          <div className="wpb_wrapper">
            ...
            >
              <div className="text-icon__container   ">
                ...
                <div className="text-icon__content-box">
                  <h4 className="text-icon__title" id="business-marketing">
                    {business_marketing}
                  </h4>
                  <p className="text-icon__text" id="sub-business-marketing">
                    {sub_business_marketing}
                  </p>
                </div>
              </div>
            ...
            >
              <div className="text-icon__container   ">
                ...
                <div className="text-icon__content-box">
                  <h4 className="text-icon__title" id="business-seo">
                    {business_seo}
                  </h4>
                  <p className="text-icon__text" id="sub-business-seo">
                    {sub_business_seo}
                  </p>
                </div>
              </div>
